...
class AclCli {
  ...
  async show(args) {
    ...
    if( response.error ) {
      debug.handle('acl show', response, args);
  ...
  async add(args) {
    ...
    debug.handle('acl add', response, args);
  ...
  async addGroup(args) {
    ...
    debug.handle('acl add-group', response, args);
  ...
  async modifyGroup(args) {
    ...
    debug.handle('acl modify-group', response, args);
