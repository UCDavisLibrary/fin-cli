...
class HttpCli {
  ...
  _stdOptionWrapper(command) {
    ...
    .option('--pretty', 'Pretty response body print if application/json')
  ...
  async startTransaction(arg) {
    ...
    var {response, body} = await api.startTransaction(options);
  ...
  async commitTransaction(arg) {
    ...
    var {response, body} = await api.commitTransaction(options);
  ...
  async rollbackTransaction(arg) {
    ...
    var {response, body} = await api.rollbackTransaction(options);
  ...
  async getVersions(args) {
    ...
    var {response, body} = await api.getVersions(options);
  ...
  async getVersion(args) {
    ...
    let options = this._initOptions(args);
    options.versionName = args.options['version-name'];

    var {response, body} = await api.getVersion(options);
  ...
  async createVersion(args) {
    ...
    var {response, body} = await api.createVersion(options);
  ...
  async revertToVersion(args) {
    ...
    var {response, body} = await api.revertToVersion(options);
  ...
  async deleteVersion(args) {
    ...
    var {response, body} = await api.deleteVersion(options);
