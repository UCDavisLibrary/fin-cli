...
class ServiceCli {
  ...
  init(vorpal) {
    ...
    vorpal
      ...
      .option('-U --url <url>', 'url of service (AuthenticationService and ClientService)')
      ...
      .description('Create a service.  Type can be [ProxyService|FrameService|WebhookService|ExternalService|ClientService]')
